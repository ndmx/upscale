...
with app.app_context():
    ...
    if Course.query.count() == 0:
        courses_data = [
            {"title": "Cybersecurity with AI", "description": "Adapt skills for AI threats in West Africa.", "modules": [
                {"title": "Intro to AI Threats", "content": "Learn basics of AI in cyber attacks."},
                {"title": "Defensive AI Tools", "content": "Hands-on with ML for detection."}
            ]},
            {"title": "Data Engineering for AI", "description": "Build pipelines for AI data.", "modules": [
                {"title": "ETL Basics", "content": "Extract, transform, load for AI."},
                {"title": "Cloud Integration", "content": "Use AWS for scalable data."}
            ]},
            {"title": "Web App Development with AI", "description": "Create AI-powered web apps.", "modules": [
                {"title": "React with AI APIs", "content": "Integrate OpenAI in frontend."},
                {"title": "Deployment", "content": "Host on Vercel for mobile users."}
            ]}
        ]
